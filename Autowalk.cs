...
public class Autowalk : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if (walkWhenTriggered && !walkWhenLookDown && !isWalking && Cardboard.SDK.BackButtonPressed) 
		{
			isWalking = true;
		} 
		else if (walkWhenTriggered && !walkWhenLookDown && isWalking && Cardboard.SDK.BackButtonPressed) 
		{
			isWalking = false;
		}
